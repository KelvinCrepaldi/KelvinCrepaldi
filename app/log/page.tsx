          ...
          >
            <div className="w-full max-w-3xl">
              ...
              <p className="mt-6 max-w-2xl text-sm leading-relaxed text-on-surface/75 md:text-base">
                Esta seção reúne notas de campo, experiências e reflexões do
                dia a dia como desenvolvedor — incidentes em produção, decisões
                de arquitetura, aprendizados em comunidade e tudo que não cabe
                num case de projeto, mas vale registrar.
              </p>
